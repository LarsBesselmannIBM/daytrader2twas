...
# This configuration was migrated on 24/05/22 at 09:56:28 from the following location: /usr/IBM/WAS855ND/profiles/Dmgr01
...
# ============================================================
TradeAdminAuthData_password_1='passw0rd'
TradeAdminAuthData_user_1='db2inst1'
TradeDataSourceAuthData_password_1='passw0rd'
...
AdminTask.createSIBus(["-bus", "TradeCluster", "-busSecurity", "false"])
AdminTask.addSIBusMember(["-fileStore", "", "-node", NodeName, "-bus", "TradeCluster", "-server", "server1"])
AdminTask.createSIBDestination(["-bus", "TradeCluster", "-name", "Trade.Topic.Space", "-type", "TopicSpace", "-node", NodeName, "-server", "server1"])
AdminTask.createSIBDestination(["-bus", "TradeCluster", "-name", "TradeBrokerJSD", "-type", "Queue", "-node", NodeName, "-server", "server1"])
...
AdminTask.createSIBJMSActivationSpec(Node, ["-name", "TradeBrokerMDB", "-jndiName", "eis/TradeBrokerMDB", "-destinationJndiName", "jms/TradeBrokerQueue", "-authenticationAlias", "TradeAdminAuthData", "-destinationType", "javax.jms.Queue", "-busName", "TradeCluster"])
AdminTask.createSIBJMSActivationSpec(Node, ["-name", "TradeStreamerMDB", "-jndiName", "eis/TradeStreamerMDB", "-destinationJndiName", "jms/TradeStreamerTopic", "-authenticationAlias", "TradeAdminAuthData", "-destinationType", "javax.jms.Topic", "-busName", "TradeCluster"])

print 'Starting Creating Connection Factories'
AdminConfigVar_7=AdminTask.createSIBJMSConnectionFactory(Node, ["-name", "TradeBrokerQCF", "-jndiName", "jms/TradeBrokerQCF", "-busName", "TradeCluster", "-type", "queue", "-authDataAlias", "TradeAdminAuthData"])
...
AdminConfigVar_9=AdminTask.createSIBJMSConnectionFactory(Node, ["-name", "TradeStreamerTCF", "-jndiName", "jms/TradeStreamerTCF", "-busName", "TradeCluster", "-type", "topic", "-authDataAlias", "TradeAdminAuthData"])
...
AdminConfigVar_0=AdminConfig.create('JDBCProvider', Node, [['classpath', '/work/config/lib/db2jcc.jar;/work/config/lib/db2jcc_license_cu.jar'], ['description', 'minVer null - maxVer null - One-phase commit DB2 JCC provider that supports JDBC 3.0. Data sources that use this provider support only 1-phase commit processing, unless you use driver type 2 with the application server for z/OS. If you use the application server for z/OS, driver type 2 uses RRS and supports 2-phase commit processing.'], ['implementationClassName', 'com.ibm.db2.jcc.DB2ConnectionPoolDataSource'], ['name', 'DB2_Universal_JDBC_Driver_Provider_Only'], ['providerType', 'DB2 Universal JDBC Driver Provider'], ['xa', 'false']])
AdminConfigVar_1=AdminTask.createDatasource(AdminConfigVar_0, ["-name", "NoTxTradeDataSource", "-jndiName", "jdbc/NoTxTradeDataSource", "-dataStoreHelperClassName", "com.ibm.websphere.rsadapter.DB2UniversalDataStoreHelper", "-componentManagedAuthenticationAlias", "TradeDataSourceAuthData", "-configureResourceProperties", "[[databaseName java.lang.String trade2db] [driverType java.lang.Integer 4] [serverName java.lang.String 9.149.245.38] [portNumber java.lang.Integer 50000] ]"])
...
AdminConfigVar_4=AdminTask.createDatasource(AdminConfigVar_0, ["-name", "TradeDataSource", "-jndiName", "jdbc/TradeDataSource", "-dataStoreHelperClassName", "com.ibm.websphere.rsadapter.DB2UniversalDataStoreHelper", "-componentManagedAuthenticationAlias", "TradeDataSourceAuthData", "-configureResourceProperties", "[[databaseName java.lang.String trade2db] [driverType java.lang.Integer 4] [serverName java.lang.String 9.149.245.38] [portNumber java.lang.Integer 50000] ]"])
...
AdminConfig.create('J2EEResourceProperty', AdminConfigVar_5, [['name', 'jmsOnePhaseOptimization'], ['type', 'java.lang.Boolean'], ['value', 'false']])
...
AdminConfig.create('J2EEResourceProperty', AdminConfigVar_5, [['name', 'retrieveMessagesFromServerOnGetMessage'], ['type', 'java.lang.Boolean'], ['value', 'true']])
